 ...
 * @num: refers to the node index used by history
 *
 * Return: size of list
 */
 ...
 * @head: refers to the address of pointer to head node
...
/**
 * print_list_str - this will print only the str element of a list_t linked list
 ...
 * @head: refers to the  address of pointer to first node
 ...
 * @head_ptr: refers to the  address of pointer to head node
 *
 * Return: void
 */
