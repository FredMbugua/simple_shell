 ...
 * @head: refers to pointer to first node
 *
 ...
 * @h: refers pointer to first node
 *
 * Return: size of list
 */
...
/**
 * node_starts_with - this will return node whose string starts with prefix
 * @node: refers to the pointer to list head
 * @prefix: refers to the string to match
 * @c: refers to the next character after prefix to match
 *
 ...
 * @head: refers to pointer to list head
 * @node: refers to pointer to the node
 *
